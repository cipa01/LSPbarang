...
<body class="bg-gray-100 flex">
    ...
    <div class="w-64 h-screen bg-gray-800 fixed">
        ...
        <nav class="mt-4">
            ...
            <a href="../petugas/laporan.php" class="block text-gray-300 py-4 px-6 hover:bg-gray-700 text-lg <?php echo ($current_page == 'laporan.php') ? 'bg-gray-700' : ''; ?>">
    ...
    <div class="ml-64 flex-1 p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold">Reports Overview</h1>
